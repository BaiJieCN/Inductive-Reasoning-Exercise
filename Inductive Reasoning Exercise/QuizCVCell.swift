...
class QuizCVCell: UICollectionViewCell {
    ...
    var question: Question? {
        didSet {
            ...
            btn5.setTitle(unwrappedQue.options[4], for: .normal)
...
//                }
    ...
    override init(frame: CGRect) {
        ...
        setupViews()
        btnsArray = [btn1, btn2, btn3, btn4, btn5]
    }
    ...
    func setupViews() {
        ...
        addSubview(btn1)
        NSLayoutConstraint.activate([btn1.topAnchor.constraint(equalTo: lblQue.bottomAnchor, constant: 20), btn1.centerXAnchor.constraint(equalTo: self.centerXAnchor, constant: -120), btn1.widthAnchor.constraint(equalToConstant: btnWidth), btn1.heightAnchor.constraint(equalToConstant: btnHeight)])
        btn1.addTarget(self, action: #selector(btnOptionAction), for: .touchUpInside)
        
        btn2 = getButton(tag: 1)
        addSubview(btn2)
        NSLayoutConstraint.activate([btn2.topAnchor.constraint(equalTo: btn1.topAnchor), btn2.centerXAnchor.constraint(equalTo: self.centerXAnchor, constant: -60), btn2.widthAnchor.constraint(equalToConstant: btnWidth), btn2.heightAnchor.constraint(equalToConstant: btnHeight)])
        btn2.addTarget(self, action: #selector(btnOptionAction), for: .touchUpInside)
        
        btn3 = getButton(tag: 2)
        addSubview(btn3)
        NSLayoutConstraint.activate([btn3.topAnchor.constraint(equalTo: btn1.topAnchor),
                                     btn3.centerXAnchor.constraint(equalTo: self.centerXAnchor),
                                     btn3.widthAnchor.constraint(equalToConstant: btnWidth), btn3.heightAnchor.constraint(equalToConstant: btnHeight)])
        btn3.addTarget(self, action: #selector(btnOptionAction), for: .touchUpInside)
        
        btn4 = getButton(tag: 3)
        addSubview(btn4)
        NSLayoutConstraint.activate([btn4.topAnchor.constraint(equalTo: btn1.topAnchor), btn4.centerXAnchor.constraint(equalTo: self.centerXAnchor, constant: 60),
                                     btn4.widthAnchor.constraint(equalToConstant: btnWidth), btn4.heightAnchor.constraint(equalToConstant: btnHeight)])
        btn4.addTarget(self, action: #selector(btnOptionAction), for: .touchUpInside)
        
        btn5 = getButton(tag: 4)
        addSubview(btn5)
        NSLayoutConstraint.activate([btn5.topAnchor.constraint(equalTo: btn1.topAnchor), btn5.centerXAnchor.constraint(equalTo: self.centerXAnchor, constant: 120),
                                     btn5.widthAnchor.constraint(equalToConstant: btnWidth),
                                     btn5.heightAnchor.constraint(equalToConstant: btnHeight)])
    ...
    let imgView: UIImageView = {
        let v=UIImageView()
        v.image = #imageLiteral(resourceName: "IR6")
